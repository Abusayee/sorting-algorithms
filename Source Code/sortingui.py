...
def try1():
    ...
    img = ImageTk.PhotoImage(Image.open("C:/Users/USER/Desktop/Group 3/Source Code/img/merge-sort.png"))
...
# Speed Scale to choose how fast or slow
    speedScale = Scale(UI_frame, from_=0, to=4.0, length=200, digits=2, resolution=0.1, orient=HORIZONTAL,
